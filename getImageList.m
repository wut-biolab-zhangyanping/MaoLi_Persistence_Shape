function [train_img_path, train_label,val_img_path, val_label, test_img_path, test_label] = getImageList()
        [train_img_list, train_y_list] = importfile('/home/zyp/MFCIS/train_and_test_file/soybean/R1/soybean_train_file_0.csv');
        [val_img_list, val_y_list] = importfile('/home/zyp/MFCIS/train_and_test_file/soybean/R1/soybean_val_file_list_0.csv');
        [test_img_list, test_y_list] = importfile('/home/zyp/MFCIS/train_and_test_file/soybean/R1/soybean_test_file_0.csv');
        train_img_file = train_img_list;
        train_y = train_y_list;
        [class, label] = importMapFile('/home/zyp/MFCIS/soybean_id.txt');
